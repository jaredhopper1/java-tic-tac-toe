...
public class Game {
    ...
    public String checkGameWinner(char [][]grid) {
        ...
        if(
                         //x at column 1
                        (gridAt(0,0) =='x' && gridAt(0,1) == 'x' && gridAt(0,2) == 'x') ||
                        //x at column 2
                        ((gridAt(1,0)=='x') && gridAt(1,1) == 'x' && gridAt(1,2) == 'x') ||
                        //x at column 3
                        ((gridAt(2,0)=='x') && gridAt(2,1) == 'x' && gridAt(2,2) == 'x') ||
                        //x at row 1
                        ((gridAt(0,0)=='x') && gridAt(1,0) == 'x' && gridAt(2,0) == 'x') ||
                        //x at row 2
                        ((gridAt(0,1)=='x') && gridAt(1,1) == 'x' && gridAt(2,1) == 'x') ||
                        //x at row 3
                        ((gridAt(0,2)=='x') && gridAt(1,2) == 'x' && gridAt(2,2) == 'x') ||
                        //x at left diagonal
                        ((gridAt(0,0)=='x') && gridAt(1,1) == 'x' && gridAt(2,2) == 'x') ||
                        //x at right diagonal
                        ((gridAt(2,0)=='x') && gridAt(1,1) == 'x' && gridAt(0,2) == 'x')
        )
        {
            result = "x wins";
            return result;
                        ...
                        //o at column 1
                        (gridAt(0,0) =='o' && gridAt(0,1) == 'o' && gridAt(0,2) == 'o') ||
                        //o at column 2
                        ((gridAt(1,0)=='o') && gridAt(1,1) == 'o' && gridAt(1,2) == 'o') ||
                        //o at column 3
                        ((gridAt(2,0)=='o') && gridAt(2,1) == 'o' && gridAt(2,2) == 'o') ||
                        //o at row 1
                        ((gridAt(0,0)=='o') && gridAt(1,0) == 'o' && gridAt(2,0) == 'o') ||
                        //o at row 2
                        ((gridAt(0,1)=='o') && gridAt(1,1) == 'o' && gridAt(2,1) == 'o') ||
                        //o at row 3
                        ((gridAt(0,2)=='o') && gridAt(1,2) == 'o' && gridAt(2,2) == 'o') ||
                        //o at left diagonal
                        ((gridAt(0,0)=='o') && gridAt(1,1) == 'o' && gridAt(2,2) == 'o') ||
                        //o at right diagonal
                        ((gridAt(2,0)=='o') && gridAt(1,1) == 'o' && gridAt(0,2) == 'o')
        )
        {
            result = "o wins";
            return result;
